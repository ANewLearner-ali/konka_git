...
from PyQt5.QtWidgets import QMessageBox, QMainWindow, QWidget, QHBoxLayout, QVBoxLayout
import sys
...
class model_scene_ScenceTV(Ui_MainWindow, QMainWindow):
    ...
    def _setup_my_ui(self):
        # 左边的布局
        l_wight = QWidget(self.centralWidget())
        l_wight.setStyleSheet("""QWidget {
        background: #001529;
...
""")
        ...
        l_layout.addWidget(self.label_14)
        l_layout.addWidget(self.pushButton_2)
        l_layout.setContentsMargins(0, 0, 0, 0)
        self.label.setMinimumSize(180, 91)
        self.pushButton_2.setMinimumSize(180, 51)
        l_layout.addStretch()
        l_wight.setLayout(l_layout)
        # 整体的布局
        all_layout = QHBoxLayout()
        all_layout.setSpacing(0)
        all_layout.setContentsMargins(0, 0, 0, 0)
        l_wight.setMinimumSize(183, 636)
        self.tabWidget.setMinimumSize(851, 661)
        all_layout.addStretch()
        all_layout.addWidget(l_wight)
        all_layout.addWidget(self.tabWidget)
        all_layout.addStretch()
